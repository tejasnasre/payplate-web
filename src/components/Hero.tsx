      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            Get your own branded restaurant invoice management app. Complete
            solution with PDF generation, WhatsApp sharing, analytics, and more.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-amber-300 text-amber-700 hover:bg-amber-50 px-8 py-4 text-lg hover:border-amber-400 transition-all duration-200"
            >
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            {/* Second Row of Mockups - apply the same changes */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
              {/* Menu Management - Modified without Mac styling */}
              <div className="transform hover:scale-105 transition-transform duration-300">
                <div className="p-4">
                  <img
